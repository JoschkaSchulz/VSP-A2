...
-module(ggt).
-import(werkzeug,[get_config_value/2, timeMilliSecond/0, reset_timer/3, logging/2]).
...
prozess_start(GGTname, Nameservice, Koordinator,ArbeitsZeit,TermZeit) ->
	...
	%Logge die anmeldung beim Koordinator
...
rechne_ggt(Mi,Y, RightN, LeftN, Koordinator, ArbeitsZeit) ->
	...
	%Warte vor der rechnung eine gewisse Zeit TODO: sind das Sekunden?
